// ~ API를 활용한 플레이어주도적 세션(ㅋ)을 위한 API 스크립트 ~
//
// 이 코드는 유지보수되지 않으며 제작과 배포 모두 다른 분들의 실제 사용을 목표로 하지 않았습니다.
// 그다지 합리적이고 아름다운 방식으로 구현되진 않은, 개인적+일시적 사용을 목적으로 마구잡이로 만들어진 스파게티 코드입니다.
// 퍼블릭하게 코드의 퀄리티에 대해 평가하지 말아주세요. 참고하시는건 무관합니다.
// 상업적 이용은 누가 하긴할까? 싶지만 세상넓고 혹시 모르니 일단 안된다고 써놓습니다.
// 이 스크립트를 개조하시는건 좋으나 수정한 코드를 재배포하지 말아주세요.
//
// *** 사용과 관련된 문의를 받지 않습니다 ***
//
// 코드 배포의 목적은 어떻게 만들었는지 궁금하신 분들이 호기심을 충족하시거나
// 이 스크립트와 유사한, 혹은 기능 일부를 활용한 개발에 참고하시라고 입니다.
// 설치&사용법이나 개조방법이나 코드의 해석 등과 관련된 질문을 하셔도 답변드릴 수 없어요.
//
// 관심갖고 끈기있게 이 안내문을 읽어주신 당신, 감사합니다!
